  ...
  return (
    <div className="p-8" style={{ maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <div className="grid gap-6" style={{ gridTemplateColumns: "1fr 1fr 300px" }}>
        ...
        {/* ── COL 1: Streak tracker + Quick stats ── */}
        ...
        {/* ── COL 2: AI Recommended Lesson (centerpiece) ── */}
        <div className="flex flex-col gap-5">
          {/* AI label */}
          ...
          >
            ...
            <div className="p-7">
              ...
              <div
                ...
                style={{ backgroundColor: "var(--secondary)", borderLeft: "3px solid var(--primary)" }}
              >
                ...
                <p style={{ fontFamily: "Inter, sans-serif", fontSize: "14px", color: "var(--foreground)", lineHeight: 1.65 }}>
                  Opanowałaś{" "}
                  <span style={{ color: "var(--accent)", fontWeight: 600 }}>80% słownictwa HSK 2</span>, ale
                  popełniłaś ostatnio błędy w kategorii{" "}
                  <span style={{ color: "var(--primary)", fontWeight: 600 }}>'Jedzenie'</span>. Powtórzenie
                  wzmocni trwałość i poprawi celność do przewidywanych{" "}
                  <span style={{ color: "var(--accent)", fontWeight: 600 }}>88%</span>.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-7">
                {["米饭", "面条", "饺子", "水果", "蔬菜"].map((word, i) => (
                  <div
                    key={word}
                    className="px-3 py-1.5 rounded-lg"
                    style={{
                      backgroundColor: i < 3 ? "rgba(79,121,66,0.08)" : "var(--secondary)",
                      border: `1px solid ${i < 3 ? "rgba(79,121,66,0.25)" : "var(--border)"}`,
                    }}
                  >
                    <span style={{ fontFamily: "'Noto Serif SC', serif", fontSize: "14px", color: i < 3 ? "var(--accent)" : "var(--muted-foreground)", fontWeight: i < 3 ? 600 : 400 }}>
                      {word}
                    </span>
                  </div>
                ))}
                ...
                >
                  <span style={{ fontFamily: "Inter, sans-serif", fontSize: "12px", color: "var(--muted-foreground)" }}>+7 więcej</span>
                </div>
              </div>
        ...
        {/* ── COL 3: Right sidebar — Forecast + recent errors + upcoming ── */}
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {["饺子", "星期", "商店", "便宜", "医院"].map((word) => (
                <div
                  key={word}
                  className="px-2.5 py-1 rounded-lg"
                  style={{ backgroundColor: "rgba(200,62,52,0.07)", border: "1px solid rgba(200,62,52,0.2)" }}
                >
                  <span style={{ fontFamily: "'Noto Serif SC', serif", fontSize: "14px", color: "var(--primary)", fontWeight: 600 }}>{word}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div
            ...
            style={{ boxShadow: "0 1px 12px rgba(26,26,26,0.04)" }}
          >
            <span style={{ fontFamily: "'Noto Serif SC', serif", fontSize: "32px", opacity: 0.1, display: "block", lineHeight: 1, marginBottom: "8px" }}>
              「
            </span>
            <p style={{ fontFamily: "'Noto Serif SC', serif", fontSize: "15px", color: "var(--foreground)", lineHeight: 1.6 }}>
              学如逆水行舟，不进则退。
            </p>
